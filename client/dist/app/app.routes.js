...
var matchup_page_component_1 = require('./components/matchup-page/matchup-page.component');
var api_page_component_1 = require('./components/api-page/api-page.component');
var routes = [
